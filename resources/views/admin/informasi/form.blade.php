...
@section('title', ($item->exists ? 'Edit' : 'Tambah') . ' Informasi Penting')

@section('content')
<h4 class="mb-3">{{ $item->exists ? 'Edit' : 'Tambah' }} Informasi Penting</h4>

<form method="POST"
      action="{{ $item->exists ? route('admin.informasi-pentings.update',$item) : route('admin.informasi-pentings.store') }}"
  ...
  <div class="col-lg-8">
    ...
    <div class="card shadow-sm">
      <div class="card-body d-flex gap-2">
        ...
        <a href="{{ route('admin.informasi-pentings.index') }}" class="btn btn-outline-secondary">Kembali</a>
      </div>
    </div>
  </div>
