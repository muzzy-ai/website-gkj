...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <a href="{{ route('admin.informasi.create') }}" class="btn btn-maroon">+ Tambah</a>
</div>

<form class="row g-2 mb-3" method="GET" action="{{ route('admin.informasi-pentings.index') }}">
  <div class="col-md-4">
    ...
    <table class="table align-middle mb-0">
      ...
      @forelse ($items as $it)
        <tr>
          ...
          <td class="text-end">
            <a href="{{ route('admin.informasi-pentings.edit',$it) }}" class="btn btn-sm btn-outline-primary">Edit</a>
            <form action="{{ route('admin.informasi-pentings.destroy',$it) }}" method="POST" class="d-inline"
